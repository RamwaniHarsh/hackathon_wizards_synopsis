...
<!--        dropdown btn-->
        <div class="dropdown" id="drop_btn">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                ...
                <li><a class="dropdown-item" href="src/coach_registration.php"><span class="d-item"> Coach Registration </span></a></li>
   ...
   <span style="color:#ff6131;">Khel</span> <span style="color:white;">Maha</span><span style="color:green;">kumbh</span>
    ...
    <a type="button" class="btn" id="explore_btn"  data-bs-target="#menu" data-bs-toggle="offcanvas">
        ...
        <?php 
            ...
            $query1 = "select * from badm";
            $result1 = mysqli_query($conn, $query1);
            $query2 = "select * from swim";
            $result2 = mysqli_query($conn, $query2);
            $query3 = "select * from vollyball";
            $result3 = mysqli_query($conn, $query3);
        ?>
                    <div class="input-field">
                      <label style="font-size:1.1em">Badminton</label>
                      <select required name="badminton">
                          <option disabled selected>Badminton</option>
                    ...
                    <div class="input-field">
                      <label style="font-size:1.1em">Swimming</label>
                      <select required name="Swimming">
                          <option disabled selected>Swimming</option>
                    ...
                    <div style="margin-left: 20px;" class="input-field">
                      <label style="font-size:1.1em">Volleyball</label>
                      <select required name="Volleyball">
                          <option disabled selected>Volleyball</option>
